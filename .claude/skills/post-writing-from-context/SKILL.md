...
[주의] 절대로 `./context/post/*`의 md 파일에 있는 글의 내용을 수정하지 않습니다. 톤앤매너를 확인후 변경하거나 글의 내용을 바꾸는 행동은 절대 하지 않습니다. 글의 내용은 그대로 유지되어야 합니다. 수정해야하는 부분은 프론트매터 및 에셋의 위치, 상단의 메타정보 뿐입니다.
